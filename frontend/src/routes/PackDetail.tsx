  ...
  return (
    <Stack gap="lg">
      ...
      <Alert color="blue" title="Export only — not applied to SC4S" variant="light">
        Downloading this bundle creates a local export file only. SC4S is not updated until you import and apply it through Manager. After applying, reload SC4S and use Splunk readback to confirm the source is live.
      </Alert>
